...
if Training:
  for epoch in range(epochs):
      ...
      if best_loss > losses[1, epoch]:
          ...
          torch.save(model_binary.state_dict(), os.path.join("/mnt/scratch/od22kob/MSC Final/Sentry-AI/Python/Models/Best_Models", "E2E_SF.pt"))
...
model_binary.load_state_dict(torch.load(os.path.join("/mnt/scratch/od22kob/MSC Final/Sentry-AI/Python/Models/Best_Models", "E2E_SF.pt")))
